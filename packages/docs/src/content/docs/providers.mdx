...
| `o1` | Deep reasoning, complex problems |
| `o1-mini` | Reasoning, economical |
...
| `gemini-2.5-flash` | Fast responses, code search |
| `gemini-2.0-flash` | Quick tasks, media analysis |
